...
<html lang="en">
    ...
    <body>
        ...
        %>
        <script>alert('Request sending failed');</script>
        <%
            }
        %>
            ...
            <div class="row">
                <div class="box" style="height: 400px;">
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        ...
                        <form style="margin-left: 430px" action="searchaction.jsp" method="post">
                            <input type="text" name="search" style="width: 300px;text-align: center"/><br /><br />
                            <input type="submit" value="Search" style="width: 100px;height: 32px;background: white;border: none;color: black;border-color: black;margin-left: 95px"/>
                        </form>
                    </div>
                </div>
            </div>
