                ...
                <div class="box" style="height: 400px;">
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        ...
                        <table border="1" style="text-align: center;margin-left: 100px">
                            <tr>
                                <th width="5%" style="text-align: center">File ID</th>
                                <th width="5%" style="text-align: center">File Name</th>
                                <th width="5%" style="text-align: center">File Size</th>
                                <th width="5%" style="text-align: center">Upload Time</th>
                            </tr>
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from upload where uemail='" + email + "'");
                                        while (rs.next()) {%>
                                        <td><%=rs.getString("fid")%></td>
                                        <td><%=rs.getString("filename")%></td>
                                        <td><%=rs.getString("fsize")%>&nbsp;KB</td>
                                        <td><%=rs.getString("utime")%></td>
                                        </tr>
                                        <%}
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
