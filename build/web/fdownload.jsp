            ...
            <div class="row">
                <div class="box" style="height: 400px;">
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        <center><h3>File Download Details</h3></center>
                        <table border="1" style="text-align: center;margin-left: 420px">
                            <tr>
                                <th style="text-align: center;width: 100px">File ID</th>
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from request where uemail ='" + email + "' AND status='Yes'");
                                        while (rs.next()) {
                                ...
                                <td> <a href="verify.jsp">Download</a></td>  
                            </tr>
                            <%}
                                } catch (Exception ex) {
                                    ex.printStackTrace();
